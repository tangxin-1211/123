...
const [a,b] = ['tangxin',true,1,2,2,1];
console.log(`a=${a}, b=${b}`)
...
avengers.unshift("tangxin");
console.log(avengers);

const avengers = ['美国', '钢铁', '雷神', '绿巨人'];
const heroes = ['蝙蝠','神奇女','闪电', '水行'];
const ah = avengers.concat(heroes);
console.log(avengers,heroes,ah);


const avengers = ['美国', '钢铁', '雷神', '绿巨人'];
const heroes = ['蝙蝠','神奇','闪电', '水行'];
...
const avengers = ['美国', '钢铁', '雷神', '绿巨人'];
const a = avengers.indexOf('美国');
console.log(a);

const avengers = ['美国', '钢铁', '雷神', '绿巨人'];
const b = avengers.includes("美国")
console.log(b)
